...
//         };
//
//         // TODO: this might not e necessary
//         // if config_file == null() {}
//
...
//     fn set_ip(&mut self, address: String) { self.ip_address = host}
...
//     fn get_max_fd(&self) -> &int { &self.max_fd }
...
// fn sigint_handler(client: Client, signal: int) {
//     if signal {
